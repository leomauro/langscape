...
compound_stmt: if_stmt | while_stmt | for_stmt | try_stmt | with_stmt | funcdef | classdef | decorated | repeat_stmt | switch_stmt | thunk_stmt
...
atom: ('(' [yield_expr|testlist_comp] ')' |'[' [listmaker] ']' |'{' [dictorsetmaker] '}' |'`' testlist1 '`' |NAME | NUMBER | STRING+) | IPv4Address
...
comp_for: 'for' exprlist 'in' or_test [comp_iter] | 'for' exprlist 'with' expr '=' expr
