def build_cstbuilder(cstbuilder):
    ...
    atom             = cstbuilder.builder(111007, 'atom', "atom: '(' rhs ')' | NAME | STRING | variable")
    ...
    item             = cstbuilder.builder(111006, 'item', "item: '[' rhs ']' | atom ['*' | '+' | repeated]")
    ...
    variable         = cstbuilder.builder(111005, 'variable', "variable: '$' '(' NAME '=' NAME ')'")
    return locals()
